    ...
    <div class="sidebar">
        ...
        <nav class="mt-2 ">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li><a href="{{ route('admin.category.index') }}"> {{ __('messages.category') }}</a></li>
                <li><a href="{{ route('admin.question.index') }}"> {{ __('messages.question') }}</a></li>
                <li><a href="{{ route('admin.product.index') }}">{{ __('messages.product') }}</a></li>
                <li><a href="{{ route('admin.customer.index') }}">{{ __('messages.customer') }}</a></li>
