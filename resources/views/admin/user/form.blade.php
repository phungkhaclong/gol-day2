...
@section('main')
    ...
    @php
    $types = \App\Models\User::TYPE;
    @endphp
    @if (!empty($user))
        <div class="container-fluid">
            <label for="type" class="form-label"> {{ __('user.User Type') }} </label>
            <input name="type" id="type" class="form-control mb-2"
                value="{{ empty($user->type) ? 'admin' : array_search($user->type, $types) }}" disabled>
        </div>
    @endif
    <div class="container-fluid">
    ...
    @if (!empty($user))
        <div class="container-fluid">
            ...
            <input name="verified_at" id="verified_at" class="form-control mb-2" value="{{ $user->verified_at }}"
                disabled>
        </div>
    @endif
    <div class="container-fluid">
    ...
    @if (!empty($user))
        <div class="container-fluid">
            ...
            <input name="created_at" id="created_at" class="form-control mb-2" value="{{ $user->created_at }}"
                disabled>
        </div>
        <div class="container-fluid">
            <label for="updated_at" class="form-label"> {{ __('user.Updated At') }} </label>
            <input name="updated_at" id="updated_at" class="form-control mb-2" value="{{ $user->updated_at }}"
                disabled>
        </div>
    @endif
        <div class="row mt-3">
